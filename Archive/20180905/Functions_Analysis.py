...
#    data_tmp = table_tmp
    if need_date:
        if data_tmp[column_name_transaction_time].get(0).__class__ is str:
...
#        list_banks = agent_bank_names
    ...
    data_tmp.loc[tmp_select,"FMU"] = "JPY-BTMU"
    ...
    data_tmp.loc[tmp_select,"FMU"] = "GBP-CHAPS"
    ...
    data_tmp.loc[tmp_select,"FMU"] = "GBP-CREST"
    ...
    data_tmp.loc[tmp_select,"FMU"] = "CAD-LVTS"
    ...
    data_tmp.loc[tmp_select,"FMU"] = "EUR-TARGET2"
    ...
    data_tmp.loc[tmp_select,"FMU"] = "EUR-Deutsche"

    Deut_bank = search_agent_bank(agent_bank_names,'INTESA SANPAOLO SPA,MILANO')
    tmp_select = (data_tmp[column_name_agent_bank_name] == Deut_bank)&(data_tmp[column_name_account_type] == "PRI")&(data_tmp[column_name_currency] == "EUR")
    data_tmp.loc[tmp_select,"FMU"] = "EUR-Intesa"
    data_tmp['FMU'].describe()
