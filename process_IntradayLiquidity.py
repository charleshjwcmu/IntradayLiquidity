...
#        start_date = datetime.datetime.strptime('2018-06-25 00:00:00', '%Y-%m-%d %H:%M:%S')
        ...
        start_date = datetime.datetime.strptime('2018-07-02 00:00:00', '%Y-%m-%d %H:%M:%S')
...
def update_table1(table_name = "BCBS_248_Data_Extract_A1_Report"):
    ...
    balance_type = column_name_transaction_amount
    attribute_groupby = [column_name_transaction_type,column_name_legal_entity,column_name_fmu]
    file_total_deposit_client = misc_dir+"/RawData/"+balance_type+"_By_"+ "_and_".join(attribute_groupby)+".xlsx"
    update_intraday_stat_from_A1_Extract_Table(file_total_deposit_client,balance_type,attribute_groupby,table_name)
...
#        attribute_groupby = [column_name_company,column_name_group]
    if PRODUCTION_ENVRIONMENT:
        ...
        start_date = datetime.datetime.strptime('2016-11-21 00:00:00', '%Y-%m-%d %H:%M:%S')
...
#                    transaction_type = "CREDIT"
                ...
                if not FedBalance:
                    ...
                    le = "SSBT BOSTON"
                    running_total_day[le] = table_tmp[table_tmp[column_name_legal_entity]==le].groupby(aggregate_by).agg({column_name_transaction_amount:sum})[column_name_transaction_amount].cumsum() + fed_balance
...
def update_table4():
    ...
    extract_percentiles(table_name='RUNNINGTOTAL_TRANSACTION_AMOUNT_CREDIT')
